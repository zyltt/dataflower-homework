...
//      dsc.setDriverName("com.mysql.cj.jdbc.Driver"); //mysql8.0使用
        ...
        dsc.setPassword("NJUshf687");
        dsc.setUrl("jdbc:mysql://127.0.0.1/dm?useUnicode=true&characterEncoding=utf8");
...
//        strategy.setInclude(new String[]{"article", "article_data"}); // 需要生成的表.如果需要生成所有的, 注释掉此行就可以
        ...
        pc.setParent("com.example.dataflowerthree");// 自定义包路径
